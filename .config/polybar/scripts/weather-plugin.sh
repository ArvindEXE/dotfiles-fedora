...
function setIcons {
    ...
    if [ $BEAUFORTICON == "yes" ];then
        ...
        if [ $WINDFORCE -le 1 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 1 ] && [ $WINDFORCE -le 5 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 5 ] && [ $WINDFORCE -le 11 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 11 ] && [ $WINDFORCE -le 19 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 19 ] && [ $WINDFORCE -le 28 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 28 ] && [ $WINDFORCE -le 38 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 38 ] && [ $WINDFORCE -le 49 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 49 ] && [ $WINDFORCE -le 61 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 61 ] && [ $WINDFORCE -le 74 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 74 ] && [ $WINDFORCE -le 88 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 88 ] && [ $WINDFORCE -le 102 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 102 ] && [ $WINDFORCE -le 117 ]; then
            WINDICON=""
        elif [ $WINDFORCE -gt 117 ]; then
            WINDICON=""
        fi
    fi
    if [ $KNOTS = "yes" ]; then
